...
from control.course_board_mgmt import course_board


course_comment = Blueprint("course_comment", __name__)
...
def create_comment(idx):
    ...
    result = mongo_db.course_comment_collection.insert_one(comment)  # mongodb insert
    print("creat_ok")
